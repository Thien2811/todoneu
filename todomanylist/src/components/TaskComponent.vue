<template>
    <div class="container rounded-3" :style="getPriorityStyle(priority)">
      <div> Aufgabe: 
      ...
      <div class="beschreibung"> Beschreibung:
  ...
  const props = defineProps(["id", "taskname","priority","aufgabenbeschreibung","person", "date", "time"])
